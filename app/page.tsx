...
export default function Page() {
  ...
  const managerBoardBottomOffset = useFloatingButtonPosition(144); // 144px base position
  ...
  return (
    <main className="min-h-screen bg-bg-app text-text-main pb-20 theme-transition flex flex-col">
      ...
      >
        <Users className="w-6 h-6 text-white transition-transform duration-300" />
      ...
      {isManagerBoardHovered && !isManagerBoardOpen && (
        <div 
          className="fixed right-20 z-50 px-3 py-2 rounded-lg bg-gray-900 text-white text-sm whitespace-nowrap shadow-lg animate-in fade-in slide-in-from-right-2 duration-200"
          style={{ bottom: `${managerBoardBottomOffset}px` }}
        >
          Manager Board
        </div>
